-- Dati iniziali: stesse frasi su ogni installazione (qualsiasi PC)
-- Inserisce le 100 frasi (stesso contenuto del backup)
-- Le virgolette doppie nelle stringhe sono consentite in PostgreSQL
...
-- Imposta la sequenza per i prossimi ID (così nuovi inserimenti funzionano correttamente)
SELECT setval(pg_get_serial_sequence('phrases', 'id'), 100);
